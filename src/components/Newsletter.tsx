	...
	return (
		<div className="w-screen flex flex-col items-center mt-10">
			...
			<div className="w-full flex flex-col items-center">
				{!isEmailValid ? <p className='text-red-500'>Please enter a valid email address</p> : null}
				<form onSubmit={handleSubmit} className="flex flex-col items-center w-full md:w-1/2">
					<input
						...
						className=" p-1 md:p-2.5 text-lg w-5/6 md:w-3/4 mb-2.5 mt-7 border-solid border-2 border-grey-300 rounded-xl"
					/>
					<button
						type="submit"
